    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <aside class="sm:block hidden w-64 bg-white border-r border-gray-200 fixed top-0 left-0 h-full pt-16">
            <div class="py-6 px-3">
                ...
                <nav class="space-y-1">
                    <Link :href="route('dashboard')" :class="['group flex items-center px-3 py-2 text-sm font-medium rounded-md focus:outline-none transition duration-150 ease-in-out', route().current('dashboard') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900']">
